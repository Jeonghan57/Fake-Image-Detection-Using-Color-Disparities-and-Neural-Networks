...
def train_net(net, train_loader, test_loader, only_fc=True,
    ...
    for epoch in range(n_iter):
        ...
        torch.save(net.state_dict(), f"./result/Experiments/StyleGAN2/ResNeXt101-32X8d/epoch_{n_iter-1}.pth")

def Evaluate_Networks(Net):
    save_path = "./result/Experiments/StyleGAN2/ResNeXt101-32X8d/"
    # data
